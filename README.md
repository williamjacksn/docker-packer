...
```sh
/path/to/packer/templates> docker container run --rm -it docker.pkg.github.com/williamjacksn/docker-packer/packer:1.6.4 --help
...
services:
  packer:
    image: docker.pkg.github.com/williamjacksn/docker-packer/packer:1.6.4
    volumes:
